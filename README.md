# 🎬 IMDB Analyzer — Sentiment Analysis + RAG + LoRA Fine-Tuning
**Hackathon Project — Real-Time Movie Review Understanding & Contextual Responses**
...
### 🔍 Sentiment Analysis (LoRA Fine-Tuned)
...
## 🏋️ Training the Sentiment Classifier
...
Training happens **only once** — if the model directory already exists, it is automatically reused.
...
## 🧪 Example Prompt Generated by the System
